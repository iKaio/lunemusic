      ...
      <div className="w-full flex justify-center">
        <div className="w-3/4">
          <div className="w-full">
            ...
            <Apps list={[
              {name: "Minecraft", icon: "https://en.uoldown.com/icon/android/minecraft-apk/minecraft-apk-android.webp", background: "https://images6.alphacoders.com/108/thumb-1920-1082090.jpg"},
